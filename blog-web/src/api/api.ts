...
export default {
  ...
  openAuthUrl: (loginType: any) => {
    return axios.get('/api/oauth/render/' + loginType)
  },
  giteeLogin: (params: any) => {
    return axios.post('/api/oauth/callback/gitee', params)
  },
  qqLogin: (params: any) => {
    return axios.post('/api/oauth/callback/qq', params)
  },
  githubLogin: (params: any) => {
    return axios.post('/api/oauth/callback/github', params)
  },
  report: () => {
