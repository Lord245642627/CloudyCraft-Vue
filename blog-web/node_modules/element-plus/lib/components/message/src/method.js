...
const normalizeOptions = (params) => {
  ...
  if (shared.isString(normalized.appendTo)) {
...
const createMessage = ({ appendTo, ...options }, context) => {
  ...
  const vnode = vue.createVNode(message$2["default"], props, shared.isFunction(props.message) || vue.isVNode(props.message) ? { default: props.message } : null);
