export declare const ElTransfer: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    readonly renderContent: {
        readonly type: import("vue").PropType<(h: typeof import("vue").h, option: import("./src/transfer").TransferDataItem) => import("vue").VNode<import("vue").RendererNode, import("vue").RendererElement, {
            [key: string]: any;
