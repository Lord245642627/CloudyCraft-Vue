<template>
  <el-card class="main-card">
    ...
    <div class="album-info">
      <el-image fit="cover" class="album-cover" :src="album.albumCover" />
      <div class="album-detail">
        ...
        <div>
          <span v-if="album.albumInfo" class="album-desc">
            {{ album.albumInfo }}
          </span>
        ...
        <el-col :md="4" v-for="item of photos" :key="item.id">
          <el-checkbox :label="item.id">
            <div class="photo-item">
              ...
              <el-image fit="cover" class="photo-img" :src="item.photoUrl" :preview-photoUrl-list="photos" />
    ...
    <el-dialog :visible.sync="editPhoto" width="30%">
      ...
      <el-form label-width="80px" size="medium" :model="photoForm">
        ...
        <el-form-item label="照片描述">
          <el-input style="width: 220px" v-model="photoForm.photoInfo" />
        </el-form-item>
      </el-form>
      <div slot="footer">
        ...
        <el-radio-group v-model="albumId">
          <div class="album-check-item">
            <template v-for="item of albumList">
              <el-radio v-if="item.id != album.id" :key="item.id" :label="item.id" style="margin-bottom: 1rem">
